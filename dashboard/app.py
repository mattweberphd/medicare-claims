...
@reactive.calc
def f_responsibility_ip():

    return f_responsibility(rxr, "Inpatient")


@reactive.calc
def f_responsibility_op():

    return f_responsibility(rxr, "Outpatient")


@reactive.calc
def f_responsibility_car():

    return f_responsibility(rxr, "Carrier")
...
with ui.layout_columns():
    ...
    with ui.card(full_screen=True):
        ...
        def sex_bar():
            ...
            sex_bar = px.bar(sorted, x="MEDREIMB_IP", y="Sex", orientation="h")
